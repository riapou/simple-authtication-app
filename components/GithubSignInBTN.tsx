...
export default function SignInWithGithub() {
  return (
    <button
      ...
      className='w-full flex items-center justify-center gap-2 rounded-md border border-gray-300 px-4 py-2 font-medium text-gray-700 hover:bg-gray-100 transition'
    >
      <svg
